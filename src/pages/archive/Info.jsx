        ...
        <div className='card my-5 d-flex justify-content-between ' >
            <Row className='bottom' >
                <Col sm={12} md={6} className='d-flex flex-column mt-2 justify-content-start align-items-start'>
                    ...
                    <Button variant='danger' onClick={claimIt} className='w-100 mt-2'>Claim</Button>
                </Col>
                <Col sm={12} md={6} className='d-flex flex-column mt-2 justify-content-start align-items-start'>
                    <div className='d-flex '>
                        <span>Pls Staked:</span><span className={!value ? 'text-white px-2' : 'text-green px-2'}>{assets ? Math.round(formatEther(assets[1]) * 1000000) / 1000000 : 0} Pls</span>
                    </div>
                    <Button variant='danger' onClick={() => withdraw()} className='w-100 mt-2'>Unstake</Button>
                </Col>
            </Row>
